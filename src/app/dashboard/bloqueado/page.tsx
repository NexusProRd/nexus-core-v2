...
export default function BloqueadoPage() {
  ...
  useEffect(() => {
    fetch('/api/config/whatsapp-soporte')
      .then(r => r.json())
      .then(d => { if (d.numero) setWhatsapp(d.numero) })
      .catch(() => {})
  }, [])

  const mensajeWhatsApp = encodeURIComponent(
    '¡Hola Nexus! Me registré en la plataforma y mi cuenta aún no ha sido aprobada. Quisiera saber el estado de mi solicitud.'
  )

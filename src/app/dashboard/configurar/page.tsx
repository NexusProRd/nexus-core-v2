  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-2xl mx-auto py-4 sm:py-6 px-4 overflow-x-hidden">
        {error && (
          <div className="bg-rose-50 border border-rose-200 text-rose-700 px-4 py-3 rounded-xl text-sm mb-4">{error}</div>
        )}
        {success && (
          <div className="bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm mb-4">{success}</div>
        )}

        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-5">

            {/* ===== PERFIL DE MARCA ===== */}
            <div className="border-b border-slate-200 pb-1">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Perfil de Marca</h3>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Logo de la Tienda</label>
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                {logoPreview ? (
                  <img src={logoPreview} alt="Logo" className="w-16 h-16 sm:w-20 sm:h-20 object-contain rounded-xl border border-gray-300 shrink-0" />
                ) : (
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-slate-100 rounded-xl flex items-center justify-center shrink-0">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Nombre Comercial</label>
              <input type="text" name="nombre_comercial" defaultValue={perfil?.nombre_comercial || ''}
                className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" />
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Link Personalizado</label>
              <div className="flex items-center gap-1.5 sm:gap-2 px-3 py-2.5 bg-slate-50 border border-gray-300 rounded-xl text-sm text-slate-500">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Slogan</label>
              <input type="text" name="slogan" defaultValue={perfil?.slogan || ''} maxLength={60}
                className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="Tu lema aquí..." />
              <p className="text-xs text-slate-400 mt-1">Máximo 60 caracteres</p>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Categorías de la Tienda (Separadas por comas)</label>
              <input type="text" name="categorias" defaultValue={perfil?.categorias || ''} className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="Ej: Ramos, Cajas, Cumpleaños, Globos" />
              <p className="text-xs text-slate-400 mt-1">Escribe las categorías de tu negocio separadas por comas (,)</p>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Sobre Nosotros</label>
              <div className="border border-gray-300 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-[var(--primary)]">
                <div className="flex gap-1 px-3 py-2 bg-slate-50 border-b border-gray-200">
                ...
                <textarea id="sobre-nosotros" value={sobreNosotros} onChange={e => setSobreNosotros(e.target.value)} rows={5}
                  className="w-full px-3 py-2.5 text-sm text-slate-900 outline-none resize-none" placeholder="Cuenta tu historia..." />
              </div>
              <p className="text-xs text-slate-400 mt-1">Usa &lt;strong&gt;, &lt;em&gt; para formato</p>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">WhatsApp</label>
            ...
            <div className="border-b border-slate-200 pb-1 pt-2">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Apariencia</h3>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-3">Paleta de Colores</label>
            ...
            <details className="group">
              ...
              <div className="mt-3">
                <label className="block text-sm font-bold text-slate-800 mb-2">Color Principal (manual)</label>
                <div className="flex items-center gap-3">
                  <input type="color" name="color_primario" defaultValue={perfil?.color_primario || '#3B82F6'}
                    className="w-12 h-12 rounded-xl border border-gray-300 cursor-pointer shrink-0"
                  ...
                  <input type="text" name="color_primario_hex" defaultValue={perfil?.color_primario || '#3B82F6'}
                    className="flex-1 px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm"
            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Mensaje de Bienvenida</label>
            ...
            {/* ===== REDES SOCIALES ===== */}
            <div className="border-b border-slate-200 pb-1 pt-2">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Redes Sociales</h3>
            </div>

            <div className="space-y-3">
              <div>
                <label className="block text-sm font-bold text-slate-800 mb-1">Instagram</label>
                <input type="url" name="instagram" defaultValue={perfil?.instagram || ''}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="https://instagram.com/tutienda" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-800 mb-1">Facebook</label>
                <input type="url" name="facebook" defaultValue={perfil?.facebook || ''}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="https://facebook.com/tutienda" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-800 mb-1">TikTok</label>
                <input type="url" name="tiktok" defaultValue={perfil?.tiktok || ''}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="https://tiktok.com/@tutienda" />
              </div>
              <div>
                <label className="block text-sm font-bold text-slate-800 mb-1">Ubicación (Google Maps)</label>
                <input type="url" name="google_maps" defaultValue={perfil?.google_maps || ''}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm" placeholder="https://maps.google.com/?q=..." />
              </div>
            </div>

            {/* ===== DATOS FISCALES ===== */}
            <div className="border-b border-slate-200 pb-1 pt-2">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Datos Fiscales</h3>
            </div>

            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">Dirección de la Tienda</label>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">RNC (Opcional)</label>
            ...
            {/* ===== HORARIOS ===== */}
            <div className="border-b border-slate-200 pb-1 pt-2">
              <h3 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Horarios</h3>
            </div>

            <div>
              <textarea name="horario" defaultValue={perfil?.horario || ''} rows={4}
                className="w-full px-3 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary)] text-slate-900 text-sm resize-none"
        ...
        {esDueno && <div className="mt-8 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 sm:p-6 space-y-4">

...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/pcc/configuracion-comercial', label: 'Config. Comercial', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z' },
    ],
  },
  {
    group: 'Sistema',
...
export default function PccLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex">
      ...
      <LoginVigiladoModal />
      <PwaRegister swUrl="/pcc/sw.js" scope="/pcc" manifestUrl="/api/manifest/pcc" logoUrl={landingLogo} />
    </div>
  )
}

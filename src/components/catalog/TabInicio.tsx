          ...
          <div className="relative min-h-[300px] sm:min-h-[340px] flex items-end">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-8 w-full">
              <div className="flex items-center gap-4">
                ...
                {numeroLimpio && (
                  <a href={`https://wa.me/${numeroLimpio}?text=${encodeURIComponent('¡Hola! Quiero información sobre sus productos.')}`} target="_blank" rel="noopener noreferrer"
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-slate-100 shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="group">
              ...
              {numeroLimpio ? (
                <a
                  href={`https://wa.me/${numeroLimpio}?text=${encodeURIComponent('¡Hola! Quiero información sobre sus productos.')}`}
                  target="_blank"
